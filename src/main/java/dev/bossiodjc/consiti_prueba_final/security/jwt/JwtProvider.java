...
public class JwtProvider {
    ...
    public String generateToken(Authentication auth){
        UsuarioActual u = (UsuarioActual) auth.getPrincipal();
        List<String> auths = new ArrayList();
        auths.add("ROLE_USER");
        return Jwts.builder().setSubject(u.getUsername()).claim("roles", auths)
                .setIssuedAt(new Date()).setExpiration(new Date(new Date().getTime()+this.expiration))
